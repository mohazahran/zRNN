...
def generateText(lstm, v2i, i2v, startWordSeed, wordCount):
    if startWordSeed is None: 
        startWordSeed = random.choice(v2i.keys())
    if startWordSeed not in v2i:
